...
namespace Asm03_17_VuDucHuy.Controllers
{
    public class AppUsersController : Controller
    {
        ...
        public AppUsersController(Assignment03PRN221Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AppUsers != null ? 
                          ...
                          Problem("Entity set 'Assignment03PRN221Context.AppUsers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Assignment03PRN221Context.AppUsers'  is null.");
            }
            var appUser = await _context.AppUsers.FindAsync(id);
            if (appUser != null)
            {
